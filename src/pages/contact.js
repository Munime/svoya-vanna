...
const About = () => (
  <Layout>
    ...
    <div className="grid bg-primary -m-4">
      <div className="m-4 mt-8 font-display font-light text-light text-md leading-8 lg:mx-12 lg:text-center lg:mt-24">
        <p>
      ...
      <div className="m-4 mt-8 font-display font-light text-light text-md leading-8 lg:mx-12 lg:text-center lg:mb-24">
        <p>
      ...
      <div className="lg:grid lg:grid-cols-2 lg:gap-4">
        <div>
          ...
          <div className="flex overflow-hidden justify-center">
            <button className="flex m-4 justify-between items-center px-4 border border-light text-light py-2 w-screen font-display tracking-widest md:w-96">
              <svg
          ...
          <div className="flex overflow-hidden mb-12 justify-center">
            <button className="flex m-4 justify-between items-center px-4 border border-light text-light py-2 w-screen font-display tracking-widest md:w-96">
              <svg
                className="hover:fill-primary"
                width="24"
        ...
        <div>
          ...
          <div className="md:flex md:justify-center ">
            <form>
              <div className="flex flex-col m-4 md:w-96">
                <input
                  className="font-display border border-light bg-primary py-2 px-3 text-light"
                  type="text"
                  placeholder="Імя"
                />
              </div>
              ...
              <button className="block text-primary font-display font-medium uppercase rounded-sm bg-sky py-2 px-8 text-center mx-auto my-0 mt-4 mb-24 hover:bg-secondary hover:text-light focus:outline-none focus:ring-secondary focus:ring-2 focus:ring-opacity-50">
                Надіслати
              </button>
            </form>
          </div>
