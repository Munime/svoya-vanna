    ...
    <div className="bg-secondary -m-4">
      ...
      <div className="p-4 pt-8 font-display font-normal text-sm tracking-widest leading-8 lg:p-12 lg:leading-9">
        <p>
          ...
          відрізняється тим, що при її виготовленні до складу сполучного вводять
          не звичайні карбамідо-формальдегідні смоли, а сечовини-меламінові. Їх
          розпізнавальним кольором на зрізі є зелений.
          <br />
          ...
          схильність до утворення тріщин, щільність, світлонепроникність і інші
          показники. Крім того, вологостійкі плити піддаються контролю за
          ...
          колір згідно RAL), шпоном, плівкою або скло в алюмінієвій рамці. Форма
          фасадів виготовлених з МДФ - підбирається суто індивідуально.
          <br />
