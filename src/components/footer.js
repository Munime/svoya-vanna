  ...
  return (
    <footer className="bg-secondary grid">
      <div className="flex flex-col justify-center items-center">
        <div className="p-8 lg:m-32">
          <h2 className="font-display font-bold text-xl text-light lowercase leading-relaxed tracking-widest lg:text-sky lg:text-3xl">
            Тримай зв'язок
          </h2>
        </div>
        <div className="flex flex-row justify-between w-full font-latin text-light tracking-widest px-20 py-2 my-2 hover:bg-primary cursor-pointer md:w-96 md:px-2 lg:text-xl lg:w-2/4 lg:px-8">
          <p>Viber</p>
          <svg
            width="25"
            height="25"
        ...
        <div className="flex flex-row justify-between w-full font-latin text-light tracking-widest px-20 py-2 my-2 mb-8 hover:bg-primary cursor-pointer md:w-96 md:px-2 lg:mb-48 lg:text-xl lg:w-2/4 lg:px-8">
          <p>Kyivstar</p>
          <svg
            width="31"
            height="29"
      ...
      <div className="flex justify-center text-sky font-latin p-4">
        © {new Date().getFullYear()}, Cretated by{" "}
        <a
          className="text-primary hover:text-light focus:outline-none focus:ring-2 focus:ring-sky focus:border-transparent"
